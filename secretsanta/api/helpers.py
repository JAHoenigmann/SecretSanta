class email_string():
    ...
    def entry_message(self):
        ret_str = f"Hello {self.giver['first_name'].title()} {self.giver['last_name'].title()},\n\n"
    ...
    def operation_message(self, gift_recipient=None):
        ...
        ret_str += f"{self.gift_recipient['first_name'].title()} {self.gift_recipient['last_name'].title()}\n"
        ret_str += f"{self.gift_recipient['street_address'].title()}\n"
        ret_str += f"{self.gift_recipient['city'].title()}, {self.gift_recipient['state'].title()}, {self.gift_recipient['zip_code'].title()}\n\n"
